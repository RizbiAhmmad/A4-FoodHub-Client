        ...
        <div className="h-32 bg-linear-to-r from-blue-600 to-indigo-700 relative">
          <div className="absolute -bottom-12 left-8 md:left-12">
            <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-white dark:bg-gray-950 p-1.5 shadow-xl">
              <div className="w-full h-full rounded-full bg-linear-to-tr from-blue-400 to-indigo-600 flex items-center justify-center text-3xl md:text-5xl font-bold text-white border-4 border-white dark:border-gray-950">
                {user.name.charAt(0)}
              </div>
            </div>
          </div>
            ...
            {user.providerProfile && (
              <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-3xl border border-gray-100 dark:border-gray-700/50 space-y-4">
                <h2 className="text-lg font-bold flex items-center gap-2 text-blue-500">
                  <Shield size={20} /> Restaurant Details
                </h2>
                ...
                <div className="space-y-3">
                  ...
                  <p className="flex justify-between items-center text-sm pt-2 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <span className={`flex items-center gap-1.5 text-sm font-bold ${
                      ...
                      <BadgeCheck size={18} />
                      {user.providerProfile.isApproved ? "Verified Partner" : "Verification Pending"}
                    </span>
                  </p>
                </div>
              </div>
