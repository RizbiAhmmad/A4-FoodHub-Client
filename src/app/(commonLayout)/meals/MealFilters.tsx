      ...
      <div className="bg-white dark:bg-gray-900 p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm">
        ...
        <div className="space-y-1">
          ...
          >
            ...
            <ChevronRight
              size={16}
              className={!currentCuisine ? "opacity-100" : "opacity-0"}
            />
          </button>
          ...
          {categories.map((category) => (
            ...
            >
              ...
              <ChevronRight
                size={16}
                className={
                  currentCuisine === category.name ? "opacity-100" : "opacity-0"
                }
              />
            </button>
          ))}
      ...
      <div className="bg-white dark:bg-gray-900 p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm">
        ...
        <div className="space-y-3">
          <label className="flex items-center gap-3 cursor-pointer group">
            ...
            />
            <span
              className={`text-sm ${!currentSort ? "font-bold text-gray-900 dark:text-white" : "text-gray-600 dark:text-gray-400"}`}
            >
              Default
            </span>
          </label>
          ...
          <label className="flex items-center gap-3 cursor-pointer group">
            ...
            />
            <span
              className={`text-sm ${currentSort === "low" ? "font-bold text-gray-900 dark:text-white" : "text-gray-600 dark:text-gray-400"}`}
            >
              Price: Low to High
            </span>
          </label>
          ...
          <label className="flex items-center gap-3 cursor-pointer group">
            ...
            />
            <span
              className={`text-sm ${currentSort === "high" ? "font-bold text-gray-900 dark:text-white" : "text-gray-600 dark:text-gray-400"}`}
            >
              Price: High to Low
            </span>
          </label>
